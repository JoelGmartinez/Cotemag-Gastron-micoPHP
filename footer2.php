            ...
            <div class="footer__container">
                <div class="footer__contact">
                    <div class="footer__tenic">
                        <img src="/asset/logofh.png" loading="lazy" alt="Cotemag logo">
                        ...
                        <div class="footer__soporte">
                            ...
                            <ul>
                                <li>
                                    <a href="#" target="_blank">Educacion Superior</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">Educacion para el trabajo</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">Colegios</a>
                                </li>
                            </ul>
                        </div>
                        <div class="footer__soporte">
                            ...
                            <ul>
                                <li>
                                    <a href="https://api.whatsapp.com/send?phone=573004813444&text=Hola%2C+estoy+interesado+en+matricularme+en+COTEMAG" target="_blank">Contactenos</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">Pagos en linea</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">Acceso remoto</a>
                                </li>
                                <li>
                                    <a href="#" target="_blank">Empresa</a>
                                </li>
                                <li>
                                    <a href="https://status.q10.com/" target="_blank">Estado del servicio</a>
                                </li>
                            </ul>
                        </div>
                    </div>
